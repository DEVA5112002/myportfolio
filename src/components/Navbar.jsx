...
const Navbar = () => {
 ...
 const[toggle,setToggle]=useState(false);
  ...
  return (
    <nav className={
      `${styles.paddingX} w-full flex item-center py-5 fixed top-0 z-20 bg-primary`}>
...
<p className="text-white text-[23.5px] font-bold cursor-pointer flex"> DEV ANANTH &nbsp;
<span className="sm:block hidden">|ASPIRING ENGINEER</span>
</p>
